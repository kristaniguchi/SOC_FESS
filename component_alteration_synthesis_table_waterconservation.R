#Component alteration synthesis summary table for WATER CONSERVATION SCENARIOS
...
#from Aliso
data1 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation/Aliso_Water_Conservation_Scenario/ffm_alteration.df.overall.join.csv")
data1$subbasin.model <- as.character(data1$subbasin.model)
#from Oso and other watersheds
data2 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation/Oso_SmallCreeks_Water_Conservation/ffm_alteration.df.overall.join.csv")
...
#from San Juan - LSPC
data3 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation/San_Juan_Water_Conservation/ffm_alteration.df.overall.join.csv")
...
#Aliso low flow
data4.1 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation_lowflowbias/Aliso_Recalibration_Update/ffm_alteration.df.overall.join.csv")
#Oso low flow
data4.2 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation_lowflowbias/Oso_SmallCreeks/ffm_alteration.df.overall.join.csv")
#San Juan low flow
data4.3 <- read.csv(file="L:/San Juan WQIP_KTQ/Data/RawData/From_Geosyntec/South_OC_Flow_Ecology_for_SCCWRP/KTQ_flowalteration_assessment/Water_Conservation_lowflowbias/SanJuan_LSPC/ffm_alteration.df.overall.join.csv")
#combine into data4
...
alt.dir.name <- "WaterConservation_Aliso_SmCk_SanJuan_all_lowflowbias"
